...
<form id="s1-input-form" method="post" class="content-form">
    ...
    <div id="s1-area-sys-setup" style="display:none">
		...
		<div class="info" id="s1-reqs10">
            ...
            <?php
            $over_text = ($GLOBALS['DUPX_STATE']->mode === DUPX_InstallerMode::OverwriteInstall) ? 'over-' : '';
            ?>
			The deployment path must be <?php echo $over_text;?>writable by PHP in order to extract the archive file.  Incorrect permissions and extension such as
