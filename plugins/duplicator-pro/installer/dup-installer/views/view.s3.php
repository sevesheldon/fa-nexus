...
/* @var $GLOBALS['DUPX_AC'] DUPX_ArchiveConfig */
    ...
    $_POST['remove_redundant'] = (isset($_POST['remove_redundant'])) ? $_POST['remove_redundant'] : 0;
	...
	$active_plugins = DUPX_U::getActivePlugins($dbh, $_POST['subsite-id']);
...
<form id='s3-input-form' method="post" class="content-form">
	...
	<div class="dupx-debug">
		...
		<input type="hidden" name="secure-pass"   value="<?php echo htmlspecialchars($_POST['secure-pass']); ?>" />
        ...
        <input type="hidden" name="remove_redundant" id="remove-redundant" value="<?php echo $_POST['remove_redundant']; ?>" />
        ...
        <div id="s3-subsite-mapping">
            <table class="s3-opts">
                <tr>
                    ...
                    <td>
                        <div>
                            <input style="width: 42%!important;" type="text" name="url_old" id="url_old" value="<?php echo $subsites[0]->name ?>" readonly="readonly"  class="readonly" />
                            to
                            <input style="width: 42%!important;" type="text" name="url_new" id="url_new" value="<?php echo DUPX_U::getDefaultURL($subsites[0]->name,$main_url,$is_subdomain); ?>" />
                        </div>
                        <?php
                            unset($subsites[0]);
                        ...
                        ?>
                            <div style="margin-top: 10px;">
                                <input style="width: 42%!important;" type="text" name="mu_search[]" id="url_old_<?php echo $subsite->id ?>" value="<?php echo $subsite->name ?>" readonly="readonly"  class="readonly" />
                                to
                                <input style="width: 42%!important;" type="text" name="mu_replace[]" id="url_new_<?php echo $subsite->id ?>" value="<?php echo DUPX_U::getDefaultURL($subsite->name,$main_url,$is_subdomain); ?>" />
                            </div>
                        <?php endforeach; ?>
                    </td>
                </tr>
