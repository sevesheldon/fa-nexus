...
<!--	<div class="hdr-sub3">
	...
	<div class="s4-go-back">
		Final Steps:
		<div style="line-height:18px; padding:2px 0 0 25px">
			<i style="color:maroon">
				<i class="fa fa-exclamation-triangle"></i> Login into the WordPress Admin and remove all
				...
				to keep this site secure.
			</i><br/>
		
			Review and test the <a href="<?php echo $url_new_rtrim; ?>" target="_blank">front-end</a> for this site.
		</div>
		...
		<ul style="margin-top: 1px">
			...
			<li>To re-run the installer <a href="<?php echo "{$url_new_rtrim}/installer.php"; ?>">go back to step 1</a>.</li>
		</ul>
	</div>
