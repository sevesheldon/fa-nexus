		...
		<table class="dupx-opts">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="cpnl-user" id="cpnl-user" required="true" data-parsley-pattern="/^[\w.-~]+$/" value="<?php echo htmlspecialchars($GLOBALS['DUPX_AC']->cpnl_user); ?>" placeholder="cPanel username" />
				</td>
			</tr>
