...
class DUP_PRO_Extraction
{
    ...
    public function __construct($post)
    {
        ...
        $this->zip_arc_chunks_extract_rates = (isset($post['zip_arc_chunks_extract_rates'])) ? $post['zip_arc_chunks_extract_rates'] : array();
        $this->zip_arc_chunk_notice_no = (isset($post['zip_arc_chunk_notice_no'])) ? $post['zip_arc_chunk_notice_no'] : '-1';
        $this->zip_arc_chunk_notice_change_last_time = (isset($post['zip_arc_chunk_notice_change_last_time'])) ? $post['zip_arc_chunk_notice_change_last_time'] : 0;
