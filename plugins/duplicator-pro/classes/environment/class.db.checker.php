...
class DUP_PRO_DB_Checker implements DUP_PRO_iChecker
{
	...
	public function check()
	{
		...
		if (!$passed) {
			...
			$this->helper_messages[] = DUP_PRO_U::__("Duplicator Pro has been disabled due to insufficient database rights ({$evaluation}). "
			. "Please give database user {$user} full rights to database {$db}");
		}
