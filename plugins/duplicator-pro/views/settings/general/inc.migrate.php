...
<?php DUP_PRO_U::_e("The migrate settings screen allows you to import or export Duplicator Pro settings from one site to another.  For example if you have several storage locations "
...
<form id="dup-tools-form-export" action="<?php echo self_admin_url('admin.php?page=duplicator-pro-tools&tab=data'); ?>" method="post">
	...
	<div class="dup-box">
		<div class="dup-box-title">
			...
			<?php DUP_PRO_U::_e("Export Settings") ?>
...
<div class="dup-box">
	<div class="dup-box-title">
		...
		<?php DUP_PRO_U::_e("Import Settings"); ?>
		<div class="dup-box-arrow"></div>
	</div>
...
<div id="modal-window-export" style="display:none;">
	...
	<p>
		...
		<span style="color:#BB1506"><i class="fa fa-warning"></i> <?php DUP_PRO_U::_e("For security purposes, restrict access to this file and delete after use."); ?></span> <br/>
		<br/>
...
<div id="modal-window-import" style="display:none;">
	...
	<p>
		...
		<span style="color:#BB1506"><i class="fa fa-warning"></i> <?php DUP_PRO_U::_e("Review templates and local storages after import to ensure correct path values."); ?> <br/></span>
		<br/>
