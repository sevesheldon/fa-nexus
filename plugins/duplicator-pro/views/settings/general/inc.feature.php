...
<!-- ===============================
NEW FEATURES -->
<label class="profile-type"><?php DUP_PRO_U::_e("New Features "); echo  "({$dup_version})" ; ?></label><br/>
<?php
...
<!-- ===============================
FEATURE SURVEY -->
<label class="profile-type"><?php DUP_PRO_U::_e("Want a New Feature?")?></label><br/>
<?php
...
<br/><hr size="1" />
<label class="profile-type"><?php DUP_PRO_U::_e("Experimental Features");?></label><br/>

<?php
	DUP_PRO_U::_e("Beta and Design Concepts sections let you preview upcoming features the Duplicator team is working on. Check the feature sections you would like to enable.");
?>
<br/><br/>
...
<div style="padding:0 0 0 30px">
    ...
    <p class="item">
		<?php
			DUP_PRO_U::_e('No design concept features in this release.');
		?>
	</p>
