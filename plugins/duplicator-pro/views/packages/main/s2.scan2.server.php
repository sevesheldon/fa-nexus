...
<div class="scan-item">
	...
	<div class="info">
		...
		if ($is_freelancer_plus) :
			?>
	        <span id="data-srv-brand-check"></span>&nbsp;<b><?php DUP_PRO_U::_e('Brand'); ?>: </b>&nbsp;<span id="data-srv-brand-name"><?php DUP_PRO_U::_e('Default'); ?></span><br />
	        <small id="data-srv-brand-note"><?php DUP_PRO_U::_e('The default content used when a brand is not defined.'); ?></small>
	        <hr size="1" />
			<?php
		endif;
		//WEB SERVER
...
if ($core_dir_notice) {
	...
	DUP_PRO_U::_e("The core WordPress paths below will <u>not</u> be included in the archive. These paths are required for WordPress to function!");
	echo "<br/>";
...
if ($core_file_notice) {
	echo '<small id="data-srv-wp-core-missing-dirs">';
	DUP_PRO_U::_e("The core WordPress file below will <u>not</u> be included in the archive. This file is required for WordPress to function!");
	echo "<br/>";
...
if (strlen($filter_text) > 0) {
	echo '<small>';
	DUP_PRO_U::_e("Note: Please change the {$filter_text} filters if you wish to include the WordPress core files otherwise the data will have to be manually copied"
