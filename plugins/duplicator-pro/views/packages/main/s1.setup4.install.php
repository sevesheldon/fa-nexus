...
<div class="dup-box-title">
	...
	<span id="dpro-install-secure-lock" title="<?php DUP_PRO_U::_e('Installer password protection is on') ?>"><i class="fa fa-lock"></i> </span>
	<span id="dpro-install-secure-unlock" title="<?php DUP_PRO_U::_e('Installer password protection is off') ?>"><i class="fa fa-unlock-alt"></i> </span>
	<div class="dup-box-arrow"></div>
</div>		
<div class="dup-box-panel" id="dpro-pack-installer-panel" style="<?php echo $ui_css_installer ?>">
	<div class="dpro-panel-optional-txt">
		<b><?php DUP_PRO_U::_e('All values in this section are'); ?> <u><?php DUP_PRO_U::_e('optional'); ?></u></b>
		<i class="fa fa-question-circle"
			data-tooltip-title="<?php DUP_PRO_U::_e("Setup/Prefills"); ?>"
			data-tooltip="<?php DUP_PRO_U::_e('All values in this section are OPTIONAL! If you know ahead of time the database input fields the installer will use, '
	...
	<table class="dpro-install-setup" style="margin-top:-10px">
		...
		<tr>
			<td><b><?php DUP_PRO_U::_e("Security") ?></b></td>
			<td>
				<?php
				...
				<i class="fa fa-question-circle"
				   data-tooltip-title="<?php DUP_PRO_U::_e("Security:"); ?>"
				...
				<div id="dpro-pass-toggle">
					...
					<button type="button" id="secure-btn" class="pass-toggle" onclick="DupPro.Pack.ToggleInstallerPassword()" title="<?php DUP_PRO_U::_e('Show/Hide Password'); ?>"><i class="fa fa-eye"></i></button>
				</div>
				<br/>
			</td>
		</tr>
	...
	<div data-dpro-tabs="true">
		...
		<div>
			<table class="dpro-install-tbl">
				<tr>
					<td colspan="2"><div class="dpro-install-hdr-2"><?php DUP_PRO_U::_e("cPanel Login") ?></div></td>
				</tr>
				<tr>
