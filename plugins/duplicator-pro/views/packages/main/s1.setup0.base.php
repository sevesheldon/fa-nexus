	...
	<div class="notice notice-info is-dismissible">
		<div id="dpro-da-notice">
			...
			<div id="dpro-da-notice-info">
				<?php DUP_PRO_U::_e("DupArchive is a custom archive engine designed to be faster, more stable and build larger packages on budget hosts.  A DupArchive file "
...
<form id="dup-form-opts" method="post" action="?page=duplicator-pro&tab=packages&inner_page=new2" data-parsley-validate data-parsley-ui-enabled="true" >
	...
	<div class="dpro-general-area">
		...
		<div style="float:right">
			<a href="admin.php?page=duplicator-pro-tools&tab=templates" class="button button-small" title="<?php DUP_PRO_U::_e("List All Templates") ?>" target="_blank">
				<i class="fa fa-clone"></i>
			</a>
			<a href="javascript:void(0)" onclick="DupPro.Pack.EditTemplate()"  class="button button-small" title="<?php DUP_PRO_U::_e("Edit Selected Template") ?>">
		...
		<div class="dup-notes-add">
			<a href="javascript:void(0)" onClick="jQuery('#dup-notes-area').toggle()" class="button button-small"  title="<?php DUP_PRO_U::_e('Add Notes') ?>">
				<i class="fa fa-pencil-square-o"></i>
			</a>
		</div>
...
jQuery(function($)
{
    ...
    DupPro.Pack.PopulateCurrentTemplate = function ()
    {
        ...
        if (selectedTemplate != null)
        {
            ...
            //-- Brand
            let installer_opts_brand = <?php echo $active_brand->id; ?>,
            ...
            if(installer_opts_brand_id.indexOf(installer_opts_brand) < 0) {
                installer_opts_brand = <?php echo $active_brand->id; ?>;
            }
