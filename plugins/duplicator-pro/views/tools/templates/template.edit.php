		...
		<tr>
			...
			<td>
				...
				<div id="dpro-pass-toggle">
					<input type="password" name="_installer_opts_secure_pass" id="_installer_opts_secure_pass" required="required" value="<?php echo $dup_install_secure_pass; ?>" />
					<button type="button" id="secure-btn" class="pass-toggle" onclick="DupPro.Template.ToggleInstallerPassword()" title="<?php DUP_PRO_U::_e('Show/Hide Password'); ?>"><i class="fa fa-eye"></i></button>
				</div>
