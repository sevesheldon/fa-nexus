    ...
    <tr>
        ...
        <td>
			<div class="btnnav">
				...
				<?php else : ?>
					<a href="admin.php?page=duplicator-pro-schedules&tab=schedules&inner_page=edit" class="add-new-h2"><?php DUP_PRO_U::_e("Add New"); ?></a>
				<?php endif; ?>
			</div>
        </td>
    </tr>
...
<?php if ($was_updated) : ?>
   <div class="notice notice-success is-dismissible dpro-wpnotice-box"><p><?php DUP_PRO_U::_e("Schedule Updated"); ?></p></div>
<?php endif; ?>
...
<table class="form-table">
    ...
    <tr valign="top">
        ...
        <td>
			...
			<a href="javascript:void(0)" onclick="DupPro.Schedule.EditTemplate()" style="margin-top:2px" class="button button-small" title="<?php DUP_PRO_U::_e("Edit Selected Template") ?>">
				<i class="fa fa-pencil-square-o"></i>
			</a>
			<a href="admin.php?page=duplicator-pro-tools&tab=templates" style="margin-top:2px" class="button button-small" title="<?php DUP_PRO_U::_e("List All Templates") ?>" target="edit-template">
    ...
    <tr valign="top">
        ...
        <td>
            <select id="change-mode" name="repeat_type" onchange="DupPro.Schedule.ChangeMode()" data-parsley-range='<?php echo "[$min_frequency, $max_frequency]"?>' data-parsley-error-message="<?php DUP_PRO_U::_e('Hourly frequency is only available at the Freelancer, Business or Gold levels. Level upgrade is available on the dashboard.'); ?>" >
                <option <?php DUP_PRO_UI::echoSelected($schedule->repeat_type == DUP_PRO_Schedule_Repeat_Types::Hourly) ?> value="<?php echo DUP_PRO_Schedule_Repeat_Types::Hourly; ?>"><?php DUP_PRO_U::_e("Hourly"); ?></option>
    ...
    <tr>
        ...
        <td style="padding-top:0px; padding-bottom:10px;">
            ...
            <div id="repeat-hourly-area" class="repeater-area">
                ...
                <?php _e("hours"); ?>
                <i class="fa fa-question-circle" data-tooltip-title="<?php DUP_PRO_U::_e("Frequency Note:"); ?>" data-tooltip="<?php echo DUP_PRO_U::__('Package will build every x hours starting at 00:00.') . '<br/><br/>' . $frequency_note; ?>"></i>
                <br/>
            </div>
            ...
            <div id="repeat-daily-area" class="repeater-area">
                ...
                <?php _e("days"); ?>
                <i class="fa fa-question-circle" data-tooltip-title="<?php DUP_PRO_U::_e("Frequency Note:"); ?>" data-tooltip="<?php $frequency_note ?>"></i>
                <br/>
            </div>
    ...
    <tr>
        ...
        <td>
            <p class="description" style="width:800px">
				<?php DUP_PRO_U::_e('<b>Note:</b> Schedules require web site traffic in order to start a build.  If you set a start time of 06:00 daily but do not get any traffic '
...
<script>
    jQuery(document).ready(function ($) {
		...
		DupPro.Schedule.EditTemplate = function ()
		{
			...
			var url = '?page=duplicator-pro-tools&tab=templates&inner_page=edit&package_template_id=' + templateID;
