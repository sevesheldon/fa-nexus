...
<table class="dpro-edit-toolbar">
    <tr>
        <td>
			...
			<a href="admin.php?page=duplicator-pro-settings&tab=schedule" class="button grey-icon" title="<?php DUP_PRO_U::_e("Settings") ?>"><i class="fa fa-gear"></i></a>
			<a href="admin.php?page=duplicator-pro-tools&tab=templates" id="btn-logs-dialog" class="button" title="<?php DUP_PRO_U::_e("Templates") ?>"><i class="fa fa-clone"></i></a>
        </td>
        <td>
			<div class="btnnav">
