...
<div class="wrap dup-wrap dup-support-all">
	<h1><?php DUP_PRO_U::_e('Testing Interface'); ?></h1>
    <hr size="1" />
	...
	<table class="debug-toolbar">
		<tr>
			...
			<td>
				<input type="button" class="button button-small" value="<?php DUP_PRO_U::_e('Run Tests'); ?>" onclick="DupPro.Debug.RunTests()" />
				<input type="button" class="button button-small" value="<?php DUP_PRO_U::_e('Refresh Page'); ?>" onclick="window.location.reload();" />
			</td>
